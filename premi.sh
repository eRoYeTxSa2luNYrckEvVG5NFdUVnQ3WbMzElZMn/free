...
restart_system() {
    ...
    TEXT="
<code>────────────────────</code>
<b>✨AUTOSCRIPT PREMIUM Versi free✨</b>
<code>────────────────────</code>
<code>ID     : </code><code>Free SC</code>
<code>Domain : </code><code>$domain</code>
<code>Date   : </code><code>$TIME</code>
<code>Time   : </code><code>$TIMEZONE</code>
<code>Ip vps : </code><code>$ipsaya</code>
<code>Exp Sc : </code><code>Unlimited</code>
<code>────────────────────</code>
<i>Automatic Notification from Github</i>
"'&reply_markup={"inline_keyboard":[[{"text":"ORDER SC","url":"t.me/budi_spielberg"},{"text":"GROUP","url":"https://chat.whatsapp.com/LFFipbLGSfi3tIF0FkwEbm"}]]}'
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/eRoYeTxSa2luNYrckEvVG5NFdUVnQ3WbMzElZMn/free/main/"
clear
...
wget raw.githubusercontent.com/eRoYeTxSa2luNYrckEvVG5NFdUVnQ3WbMzElZMn/free/main/limit/limit.sh && chmod +x limit.sh && ./limit.sh
clear
